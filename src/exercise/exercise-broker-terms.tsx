...
interface Props {
    ...
    sellToCoverSection?: React.ReactElement<any>
}
...
class BrokerTerms extends Component<Props, {}> {
    render() {
        const { companyName, employeeName, dateOfAgreement, exerciseWindow, averageStrikePrice,
            instrumentsToExercise, commission, brokerMinimumAmount, bankAccount, bufferPercentage, sellToCoverSection } = this.props;
        return (
            <div className="terms-es-section">
                ...
                <ol className="text-content-center terms-ordered-list block-l">
                    ...
                    <li>
                        <p>
                            The Employee confirms that he or she is entitled to receive Instruments which gives the Employee a right to acquire {formatNumber(instrumentsToExercise)} shares in the Company for an average subscription price of NOK {formatCurrency(averageStrikePrice)} per share.
                        </p>
                        <p>
                    ...
                    <li>
                        <p>
                            The Employee authorizes OI to communicate information contained in this Agreement and other relevant information as necessary to DNB. Should the Employee have any questions related to the implementation of this Agreement, they may contact OI at +47 22 34 33 32 or e-mail support@optioincentives.no
                        </p>
                    </li>
                    <li>
                        <p>
