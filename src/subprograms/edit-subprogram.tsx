...
class EditSubProgram extends Component<Props, State> {

    state = {
        modalOpen: false,
        name: this.props.selectedSubProgram ? this.props.selectedSubProgram.name : '',
        instrumentType: this.props.selectedSubProgram ? this.props.selectedSubProgram.instrumentTypeId : '',
        settlementType: this.props.selectedSubProgram ? this.props.selectedSubProgram.settlementTypeId : '',
        vesting_event_templates: this.props.selectedSubProgram ? this.props.selectedSubProgram.incentive_sub_program_template.vesting_event_templates : [],
        performance: this.props.selectedSubProgram ? this.props.selectedSubProgram.performance : false
    };
                ...
                <div>
                    <Form size={"large"} as={'form'}>
                        <div className='block-m'>
                            <Form.Input placeholder={'name'} width={10} value={name} name={'name'}
                        ...
                        <div className="text-center">
                            <Button.Group>
                                ...
                                <Button.Or/>
                                <Button positive type='submit' onClick={this.onSubPlanSave}>Save Subprogram</Button>
                            </Button.Group>
                        </div>
                    </Form>
                </div>
